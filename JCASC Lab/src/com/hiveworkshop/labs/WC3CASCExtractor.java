	...
	public static void main(String... args) {
		...
		try (final var dataSource = new WarcraftIIICASC(installPath, true)) {
			...
			case "-e" :
				...
				try (final var destinationChannel = FileChannel.open(destinationFilePath, StandardOpenOption.CREATE, StandardOpenOption.WRITE, StandardOpenOption.TRUNCATE_EXISTING)) {
